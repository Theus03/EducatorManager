        ...
        <div className="flex flex-col justify-content-center items-center mt-12">
            <div className="w-7xl flex flex-col justify-start items-start mt-4">
                ...
                <div id="form" className="w-full flex gap-3 mt-4 mb-16">
                    <input type="email" id="inputEmail" className="w-3xl p-4 border-brown rounded-lg placeholder:font-medium placeholder:text-lg" placeholder="Digite aqui seu melhor email para entrarmos em contato..." />
